...
@Component({
  selector: 'app-first-chapter-admin',
  imports: [
    NgSwitchCase,
    NgSwitch
  ],
  templateUrl: './first-chapter-admin.component.html',
  styleUrl: './first-chapter-admin.component.scss'
})
export class FirstChapterAdminComponent implements OnInit{
  posts: any[] = [];
  chapter: string | null = '';
