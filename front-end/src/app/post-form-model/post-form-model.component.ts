...
@Component({
  selector: 'app-post-form-model',
  imports: [
    NgSwitchCase,
    NgSwitch
  ],
  templateUrl: './post-form-model.component.html',
  styleUrl: './post-form-model.component.scss'
})
export class PostFormModelComponent implements OnInit{
